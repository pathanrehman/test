...
def makeCompilation(path = "./",
    ...
    #print(description)
    # Create compilation
    finalClip.write_videofile(outputFile, threads=2, remove_temp=True, codec="libx264", audio_codec="aac")

    return description
    
if __name__ == "__main__":
    makeCompilation(path = "/Users/Shaheen/Desktop/automated_youtube_channel/lowqualityreels",
